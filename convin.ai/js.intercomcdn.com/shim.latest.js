! function(e) {
    ...
    }, n.p = "https://js.intercomcdn.com/", n(n.s = 1058)
}({
    1058: function(e, t, n) {
        e.exports = n(1079)
    },
    1079: function(e, t, n) {
        "use strict";
        n.r(t);
        var r = ["position: absolute !important;", "opacity: 0 !important;", "width: 1px !important;", "height: 1px !important;", "top: 0 !important;", "left: 0 !important;", "border: none !important;", "display: block !important;", "pointer-events: none !important;"].join(" "),
            o = function(e) {
        ...
        var g = function(e, t, n) {
            ...
            y = function e(t, n) {
                ...
                r && (r.addEventListener("scroll", n), r === window.document.body ? window.addEventListener("scroll", n) : e(r, n))
            },
            O = function e(t, n) {
                var r = t.parentElement;
                r && (r.removeEventListener("scroll", n), r === window.document.body ? window.removeEventListener("scroll", n) : e(r, n))
            },
            S = function(e) {
                return {
            ...
            k = function() {
                function e(e, t, n, r) {
                    var o = this;
                    this.selector = void 0, this.timeoutValue = void 0, this.callback = void 0, this.timeout = void 0, this.waitTimeout = void 0, this.document = void 0, this.observer = void 0, this.selector = e, this.timeoutValue = t, this.callback = r, this.observer = new MutationObserver(this._check.bind(this)), this.document = window.document, this.waitTimeout = window.setTimeout((function() {
            ...
            C = function(e) {
                ...
                if ((Object(_.c)() && (a = [].concat(M)), -1 !== a.indexOf(c)) && (P(window) || -1 !== T.indexOf(i.type))) switch (i.type) {
                    case "intercom:ready":
                        ...
                        }(o, i.payload), window.addEventListener("resize", function(e) {
                            return function() {
                                e.postMessage({
                    ...
                    case "intercom:destroy-frame":
                        t = i.payload, n = t.name, (r = document.querySelector('iframe[data-name="' + n + '"]')) && r.remove();
                        break;
                    ...
                    case "intercom:remove-storage-item":
                        ! function(e, t) {
                            var n = t.type,
                                r = t.key,
                                o = "localStorage" === n ? window.localStorage : window.sessionStorage;
                            try {
                                o.removeItem(r)
                            } catch (e) {}
                        }(0, i.payload);
                    ...
                    case "intercom:add-event-listener":
                        ! function(e, t) {
                            ...
                            "reference-element-change" === n && (E[r] = {
                                removeEventListener: j(o, i),
                                source: e
                            })
                        }(o, i);
                        break;
            ...
            H = function(e) {
                if (! function(e) {
                    ...
                    m(e);
                    var t = o(e);
                    t.name = R, t.src = q.priv_sep_html_path + "/frame.html?" + V(), e.document.body.appendChild(t), D(e), u(e)
                }
            },
            N = n(13),
        ...
        var B = n(315),
            G = n(235).public_path,
            X = G + "frame.4da02b7d.js",
            Y = G + "vendor.c4b36b3c.js",
            J = G + "frame-modern.25287176.js",
            K = G + "vendor-modern.01463b29.js",
            ...
            Z = function() {
                ...
                n.id = "intercom-frame", n.setAttribute("style", "position: absolute !important; opacity: 0 !important; width: 1px !important; height: 1px !important; top: 0 !important; left: 0 !important; border: none !important; display: block !important; z-index: -1 !important; pointer-events: none;"), Object(N.l)() && n.setAttribute("style", n.getAttribute("style") + "visibility: hidden;"), n.setAttribute("aria-hidden", "true"), n.setAttribute("tabIndex", "-1"), n.setAttribute("title", "Intercom"), document.body.appendChild(n), Object(B.b)(n, '<!DOCTYPE html>\n    <html lang="en">\n      <head>\n        ' + t + "\n      </head>\n      <body>\n      </body>\n    </html>");
                var r, o = !!(r = Q()) && r[0] >= 81,
                    i = Object(B.a)(o ? J : X),
                    c = Object(B.a)(o ? K : Y);
        ...
        P(window) ? H(window) : "attachEvent" in window && !window.addEventListener || navigator && navigator.userAgent && /MSIE 9\.0/.test(navigator.userAgent) && window.addEventListener && !window.atob || "onpropertychange" in document && window.matchMedia && /MSIE 10\.0/.test(navigator.userAgent) || navigator && navigator.userAgent && U.test(navigator.userAgent) || window.isIntercomMessengerSheet || $() || (ne(), function(e, t, n) {
    ...
    13: function(e, t, n) {
        ...
        function v() {
            return !Object(r.a)() && i.some((function(e) {
